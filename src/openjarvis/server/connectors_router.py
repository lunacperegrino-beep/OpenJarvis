...
def create_connectors_router():
    ...
    def _start_sync(connector_id: str, instance: Any, *, full: bool = False) -> str:
        ...
        def _run_sync() -> None:
            try:
                ...
                engine.sync(instance, full=run_full_sync)
    ...
    def trigger_sync(connector_id: str, full: bool = False) -> Dict[str, Any]:
        ...
        status = _start_sync(connector_id, inst, full=full)
